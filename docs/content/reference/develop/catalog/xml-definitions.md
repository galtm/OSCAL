---
title: "OSCAL Catalog Model Development Snapshot XML Format Metaschema Reference"
heading: "Catalog Model Development Snapshot XML Metaschema Reference"
weight: 80
...
The following is a reference for the XML element and attribute types derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-mapping//src/metaschema/oscal_catalog_metaschema.xml) for this [model](/concepts/layer/control/catalog/).
