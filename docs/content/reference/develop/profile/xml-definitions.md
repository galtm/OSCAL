...
The following is a reference for the XML element and attribute types derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-mapping//src/metaschema/oscal_profile_metaschema.xml) for this [model](/concepts/layer/control/profile/).
...
<div xmlns="http://www.w3.org/1999/xhtml" class="xml-definition">
   ...
   <details class="remarks" open="open">
      ...
      <p class="p">In OSCAL a profile represents a set of selected <a href="https://pages.nist.gov/OSCAL/concepts/terminology/#control">controls</a> from one or more control catalogs. Such a set of controls can be referenced by an
         OSCAL <a href="https://pages.nist.gov/OSCAL/concepts/layer/implementation/ssp/">system security plan</a> (SSP) to establish a control <a href="https://pages.nist.gov/OSCAL/concepts/terminology/#baseline">baseline</a>. This effective set of controls is produced from an OSCAL profile using a deterministic,
         predictable process called <a href="https://pages.nist.gov/OSCAL/concepts/processing/profile-resolution/">profile resolution</a>.</p>
      <p class="p">A profile references one or more OSCAL catalogs or profiles to import controls for
         control selection and tailoring. A profile can also describe how a resulting catalog
         is structured. When the profile is resolved, these selections and modifications are
         processed to produce a resulting OSCAL catalog.</p>
      <p class="p">OSCAL profiles have uses beyond establishing control baselines, such as documentation
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/id">Switch to JSON</a></div>
                     <p class="formal-name">Group Identifier</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Identifies the group.</p>
                     <div class="remarks-group usa-prose">
                        <details open="open">
                           <summary class="subhead">Remarks</summary>
                           <div class="remarks">
                              <p>This optional data element is available to support hyperlinking to formal groups or
                                 families as defined in control catalogs, among other operations.</p>
                           </div>
                        </details>
                     </div>
                  </div>
               ...
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/class">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-line">markup-line</a></p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/title">Switch to JSON</a></div>
                     <p class="formal-name">Group Title</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> A name to be given to the group for use in display.</p>
                  </div>
               </div>
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/group/param" class="toc2 name">parameter</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/params">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/group/prop" class="toc2 name">property</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/props">Switch to JSON</a></div>
                     <p class="formal-name">Property</p>
                  </div>
                  <div class="body">
                     <p><span class="usa-tag">use name</span> <code class="name">prop</code></p>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/group/link" class="toc2 name">link</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/links">Switch to JSON</a></div>
                     <p class="formal-name">Link</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/group/part" class="toc2 name">part</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/parts">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/group/group" class="toc2 name">group</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/group/groups">Switch to JSON</a></div>
                     <p class="formal-name">Control Group</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/import">Switch to JSON</a></div>
         <p class="formal-name">Import Resource</p>
      </div>
      <div class="body">
         <p class="description"><span class="usa-tag">description</span> Designates a referenced source catalog or profile that provides a source of control
            information for use in creating a new overlay or baseline.</p>
         <div class="remarks-group usa-prose">
            <details open="open">
               <summary class="subhead">Remarks</summary>
               <div class="remarks">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uri-reference">uri-reference</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/import/href">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/import/include-controls">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/import/exclude-controls">Switch to JSON</a></div>
                     <p class="formal-name">Select Control</p>
                  </div>
                  <div class="body">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/insert-controls/order">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/insert-controls/include-controls">Switch to JSON</a></div>
                     <p class="formal-name">Select Control</p>
                  </div>
                  <div class="body">
                     <p><span class="usa-tag">use name</span> <code class="name">include-controls</code></p>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/insert-controls/exclude-controls">Switch to JSON</a></div>
                     <p class="formal-name">Select Control</p>
                  </div>
                  <div class="body">
                     <p><span class="usa-tag">use name</span> <code class="name">exclude-controls</code></p>
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/merge">Switch to JSON</a></div>
         <p class="formal-name">Merge Controls</p>
      </div>
      <div class="body">
         <p class="description"><span class="usa-tag">description</span> Provides structuring directives that instruct how controls are organized after profile
            resolution.</p>
         <details open="open">
            <summary>Elements (2):</summary>
            <div class="model assembly-model">
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/merge/combine">Switch to JSON</a></div>
                     <p class="formal-name">Combination Rule</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> A Combine element defines how to resolve duplicate instances of the same control
                        (e.g., controls with the same ID).</p>
                     <details open="open">
                        <summary>Attribute (1):</summary>
                        <div class="model assembly-model">
                           <div class="model-entry definition define-flag">
                              ...
                              <div class="body">
                                 <p class="description"><span class="usa-tag">description</span> Declare how clashing controls should be handled.</p>
                                 <details>
                                    <summary>Constraint (1)</summary>
                                    ...
                                    <div class="constraint">
                                       ...
                                       <ul>
                                          ...
                                          <li><strong>merge</strong>: **(deprecated)** **(unspecified)**
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     ...
                     <p class="formal-name">Flat Without Grouping</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Directs that controls appear without any grouping structure.</p>
                  </div>
               </div>
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="formal-name">Group As-Is</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Indicates that the controls selected should retain their original grouping as defined
                        in the import source.</p>
                  </div>
               </div>
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                  ...
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Provides an alternate grouping structure that selected controls will be placed in.</p>
                     <div class="remarks-group usa-prose">
                        <details open="open">
                           <summary class="subhead">Remarks</summary>
                           <div class="remarks">
                              <p>The <code>custom</code> element represents a custom arrangement or organization of controls in the resolution
                                 of a catalog. This structuring directive gives the profile author the ability to define
                                 an entirely different organization of controls as compared to their source catalog(s).</p>
                           </div>
                        </details>
                     </div>
                     <details open="open">
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify">Switch to JSON</a></div>
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/modify/set-parameter" class="toc2 name">set-parameter</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters">Switch to JSON</a></div>
                  ...
                  <div class="body">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition define-flag">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/param-id" class="toc3 name">param-id</h3>
                                 <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/param-id">Switch to JSON</a></div>
                                 <p class="formal-name">Parameter ID</p>
                              </div>
                              <div class="body">
                                 <p class="description"><span class="usa-tag">description</span> An identifier for the parameter.</p>
                              </div>
                           </div>
                           <div class="model-entry definition define-flag">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/class" class="toc3 name">class</h3>
                                 <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/class">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition define-flag">
                              <div class="instance-header">
                                 ...
                                 <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/depends-on">Switch to JSON</a></div>
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/prop" class="toc3 name">property</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/props">Switch to JSON</a></div>
                                 <p class="formal-name">Property</p>
                              </div>
                              <div class="body">
                                 <p><span class="usa-tag">use name</span> <code class="name">prop</code></p>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/link" class="toc3 name">link</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/links">Switch to JSON</a></div>
                                 <p class="formal-name">Link</p>
                              </div>
                              <div class="body">
                                 <div class="remarks-group usa-prose">
                           ...
                           <div class="model-entry definition define-field">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/label" class="toc3 name">label</h3>
                                 <p class="type"><a href="/reference/datatypes/#markup-line">markup-line</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/label">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition define-field">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/usage" class="toc3 name">usage</h3>
                                 <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/usage">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/constraint" class="toc3 name">constraint</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/constraints">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/guideline" class="toc3 name">guideline</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/guidelines">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition field">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/value" class="toc3 name">value</h3>
                                 <p class="type"><a href="/reference/datatypes/#string">string</a></p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/values">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/set-parameter/select" class="toc3 name">select</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/set-parameters/select">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/modify/alter" class="toc2 name">alter</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters">Switch to JSON</a></div>
                     <p class="formal-name">Alteration</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Specifies changes to be made to an included control when a profile is resolved.</p>
                     <div class="remarks-group usa-prose">
                        <details open="open">
                           <summary class="subhead">Remarks</summary>
                           <div class="remarks">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition flag">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/alter/control-id" class="toc3 name">control-id</h3>
                                 <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/control-id">Switch to JSON</a></div>
                                 <p class="formal-name">Control Identifier Reference</p>
                              </div>
                              <div class="body">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition define-assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/alter/remove" class="toc3 name">remove</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/removes">Switch to JSON</a></div>
                              ...
                              <div class="body">
                                 ...
                                 <details open="open">
                                    ...
                                    <div class="model assembly-model">
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/remove/by-name" class="toc4 name">by-name</h4>
                                             <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/removes/by-name">Switch to JSON</a></div>
                                             <p class="formal-name">Reference by (assigned) name</p>
                                          </div>
                                          <div class="body">
                                             <p class="description"><span class="usa-tag">description</span> Identify items remove by matching their assigned name.</p>
                                          </div>
                                       </div>
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/remove/by-class" class="toc4 name">by-class</h4>
                                             <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/removes/by-class">Switch to JSON</a></div>
                                       ...
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/remove/by-id" class="toc4 name">by-id</h4>
                                             <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/removes/by-id">Switch to JSON</a></div>
                                       ...
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/remove/by-item-name" class="toc4 name">by-item-name</h4>
                                             <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/removes/by-item-name">Switch to JSON</a></div>
                                             <p class="formal-name">Item Name Reference</p>
                                          </div>
                                          <div class="body">
                                             <p class="description"><span class="usa-tag">description</span> Identify items to remove by the name of the item's information object name, e.g.
                                       ...
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/remove/by-ns" class="toc4 name">by-ns</h4>
                                             <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/removes/by-ns">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition define-assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-profile/modify/alter/add" class="toc3 name">add</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds">Switch to JSON</a></div>
                              ...
                              <div class="body">
                                 ...
                                 <details open="open">
                                    ...
                                    <div class="model assembly-model">
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/add/position" class="toc4 name">position</h4>
                                             <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds/position">Switch to JSON</a></div>
                                       ...
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/add/by-id" class="toc4 name">by-id</h4>
                                             <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds/by-id">Switch to JSON</a></div>
                                             <p class="formal-name">Reference by ID</p>
                                          </div>
                                          <div class="body">
                                 ...
                                 <details open="open">
                                    ...
                                    <div class="model assembly-model">
                                       <div class="model-entry definition define-field">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/add/title" class="toc4 name">title</h4>
                                             <p class="type"><a href="/reference/datatypes/#markup-line">markup-line</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds/title">Switch to JSON</a></div>
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/add/param" class="toc4 name">parameter</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds/params">Switch to JSON</a></div>
                                             <p class="formal-name">Parameter</p>
                                          </div>
                                          <div class="body">
                                             <p><span class="usa-tag">use name</span> <code class="name">param</code></p>
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/add/prop" class="toc4 name">property</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds/props">Switch to JSON</a></div>
                                             <p class="formal-name">Property</p>
                                          </div>
                                          <div class="body">
                                             <p><span class="usa-tag">use name</span> <code class="name">prop</code></p>
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/add/link" class="toc4 name">link</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds/links">Switch to JSON</a></div>
                                             <p class="formal-name">Link</p>
                                          </div>
                                          <div class="body">
                                             <div class="remarks-group usa-prose">
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-profile/modify/alter/add/part" class="toc4 name">part</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/modify/alters/adds/parts">Switch to JSON</a></div>
                                             <p class="formal-name">Part</p>
                                          </div>
                                          <div class="body">
                                             <div class="remarks-group usa-prose">
   ...
   <div class="model-entry definition define-flag">
      <div class="definition-header">
         ...
         <p class="type"><a href="/reference/datatypes/#string">string</a></p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/flag/oscal-profile/pattern">Switch to JSON</a></div>
         <p class="formal-name">Pattern</p>
      </div>
      <div class="body">
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/profile">Switch to JSON</a></div>
         <p class="formal-name">Profile</p>
      </div>
      <div class="body">
         <p class="description"><span class="usa-tag">description</span> Each OSCAL profile is defined by a <code>profile</code> element.</p>
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  ...
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Provides a globally unique means to identify a given profile instance.</p>
                  </div>
               </div>
            </div>
         </details>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/profile/metadata">Switch to JSON</a></div>
                     <p class="formal-name">Document Metadata</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-profile/profile/import" class="toc2 name">import</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/profile/imports">Switch to JSON</a></div>
                     <p class="formal-name">Import Resource</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/profile/merge">Switch to JSON</a></div>
                     <p class="formal-name">Merge Controls</p>
                  </div>
                  <div class="body">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/profile/modify">Switch to JSON</a></div>
                     <p class="formal-name">Modify Controls</p>
                  </div>
                  <div class="body">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/profile/back-matter">Switch to JSON</a></div>
                     <p class="formal-name">Back matter</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/select-control-by-id">Switch to JSON</a></div>
         <p class="formal-name">Select Control</p>
      </div>
      <div class="body">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/select-control-by-id/with-child-controls">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#token">token</a></p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/select-control-by-id/with-ids">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-profile/select-control-by-id/matching">Switch to JSON</a></div>
                     <p class="formal-name">Match Controls by Pattern</p>
                  </div>
                  <div class="body">
   ...
   <div class="model-entry definition define-flag">
      <div class="definition-header">
         ...
         <p class="type"><a href="/reference/datatypes/#token">token</a></p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/flag/oscal-profile/with-child-controls">Switch to JSON</a></div>
         <p class="formal-name">Include Contained Controls with Control</p>
      </div>
      <div class="body">
