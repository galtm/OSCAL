---
title: "OSCAL Profile Model Development Snapshot JSON Format Metaschema Reference"
heading: "Profile Model Development Snapshot Model JSON Metaschema Reference"
weight: 40
...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-mapping//src/metaschema/oscal_profile_metaschema.xml) for this [model](/concepts/layer/control/profile/).
