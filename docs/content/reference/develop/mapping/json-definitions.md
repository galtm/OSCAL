---
title: "OSCAL Control Mapping Model Development Snapshot JSON Format Metaschema Reference"
heading: "Control Mapping Model Development Snapshot Model JSON Metaschema Reference"
weight: 40
...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-mapping//src/metaschema/oscal_mapping_metaschema.xml) for this [model](/concepts/layer/control/mapping/).
...
<div xmlns="http://www.w3.org/1999/xhtml" class="json-definition">
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping">Switch to XML</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping/uuid">Switch to XML</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping/source-resource">Switch to XML</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping/target-resource">Switch to XML</a></div>
                     <p class="formal-name">Mapped Resource Reference</p>
                  </div>
                  <div class="body">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-mapping/mapping/maps" class="toc2 name">map</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping/map">Switch to XML</a></div>
                     <p class="formal-name">Mapping Entry</p>
                  </div>
                  <div class="body">
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping-collection">Switch to XML</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping-collection/uuid">Switch to XML</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping-collection/metadata">Switch to XML</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-mapping/mapping-collection/mappings" class="toc2 name">mapping</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping-collection/mapping">Switch to XML</a></div>
                     <p class="formal-name">Control Mapping</p>
                  </div>
                  <div class="body">
                     <p><span class="usa-tag">group as</span> <code class="name">mappings</code></p>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-mapping/mapping-collection/back-matter">Switch to XML</a></div>
                     <p class="formal-name">Back matter</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
